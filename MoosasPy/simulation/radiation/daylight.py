...
def estimate_space_daylight_factor(space: MoosasSpace, light_transmittance: float = 0.6) -> float:
...
# during the daylight API consolidation. Use RadianceRunner for Radiance-based
# calculations.
